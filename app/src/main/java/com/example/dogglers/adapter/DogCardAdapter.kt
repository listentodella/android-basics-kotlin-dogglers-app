...
class DogCardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        lateinit var adpaterLayout:View
        if (layout == Layout.GRID) {
            Log.e(TAG, "onCreateViewHolder: this is GRID")
            adpaterLayout = LayoutInflater.from(parent.context)
                .inflate(R.layout.grid_list_item, parent, false)
        } else {
            Log.e(TAG, "onCreateViewHolder: this is v/h")
            adpaterLayout = LayoutInflater.from(parent.context)
        ...
        //  the inflated layout.
        return DogCardViewHolder(adpaterLayout)
    }
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.dogNameTextView.text = resources?.getString(R.string.dog_name, item.name)
